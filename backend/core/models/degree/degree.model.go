...
// func (repo *DegreeRepo) All(dto *dtos.DegreeFilter) (*[]Degree, error) {
// 	var data []Degree
// 	query := db.Database
...
// func (repo *DegreeRepo) UpdateById(employee *Degree) (int64, error) {
// 	result := db.Database.Model(&Degree{}).Where("id = ?", employee.ID).Updates(*employee)
// 	if result.Error != nil {
